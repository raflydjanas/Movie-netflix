...
const NavBar = () => {
  ...
  return (
    <div className=" absolute flex  justify-between px-[10rem] top-0 right-0 left-0">
      ...
      <div className="flex justify-center">
        ...
        <button className=" block h-10 mt-[3rem] bg-red-600 hover:bg-red-700 px-10 rounded-lg text-white">Sign in</button>
      </div>
    </div>
  );
};
